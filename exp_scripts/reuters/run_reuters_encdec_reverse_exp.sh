...
DATASET_PATH=${BASE_PATH}/data/Reuters21578
WORK_SCRATCH=/data/learned_models/mlc2seq
DATASET=reuters
INPUT_CONFIG_PATH=${BASE_PATH}/exp_scripts/${DATASET}/config_${DATASET}_encdec_reverse.json
...
THEANO_FLAGS='device=gpu1,floatX=float32,scan.allow_gc=True,lib.cnmem=0.95' python mlc2seq_single.py \
