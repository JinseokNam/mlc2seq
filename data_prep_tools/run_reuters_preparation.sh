...
CWD=$PWD
SRC_DIR=${CWD}/data/Reuters21578/original_dataset
OUTPUT_BASE=${CWD}/data/Reuters21578/MLC2SEQ
...
python ${CWD}/data_prep_tools/extract_plain_reuters21578_dataset.py \
--data_path ${SRC_DIR} \
--trd_path ${TRD} \
--trl_path ${TRL} \
--tsd_path ${TSD} \
